...
export default function AdminEditor() {
  ...
  return <main className={`admin-shell ${lang === "en" ? "lang-en" : ""}`} dir="rtl">
    <aside>
    ...
    <section className="admin-workspace">
      ...
      {tab !== "files" && tab !== "home" && <div className="editor-toolbar"><div><button className={lang === "ar" ? "active" : ""} onClick={() => setLang("ar")}>العربية</button><button className={lang === "en" ? "active" : ""} onClick={() => setLang("en")}>English</button></div><span>تعديل النسخة {lang === "ar" ? "العربية" : "الإنجليزية"}</span></div>}
