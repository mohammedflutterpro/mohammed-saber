...
function getDraftSecret() {
	return "56ac56c0-3edc-40dd-b070-5ebb5a4555f4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "67562056-9ca6-4716-beef-da3a2f4f84dc";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "67562056-9ca6-4716-beef-da3a2f4f84dc") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "67562056-9ca6-4716-beef-da3a2f4f84dc",
		rootBoundaryId
	});
}
/**
