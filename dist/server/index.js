globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/layout-segment-context-D14ETF02.js","assets/AdminEditor-BeJy-N5E.js","assets/page-EzctsKUG.js"];
...
function getDraftSecret() {
	return "c8b1e60d-cc0d-4ea9-8862-82533ee7c667";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "abdde1d1-4667-4a38-92e0-cd6e70d86d33";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "abdde1d1-4667-4a38-92e0-cd6e70d86d33") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "abdde1d1-4667-4a38-92e0-cd6e70d86d33",
		rootBoundaryId
	});
}
/**
...
var defaultData = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'defaultData' is called on server");
}, "6efdf509a785", "defaultData");
