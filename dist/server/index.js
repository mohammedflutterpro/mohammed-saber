globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/layout-segment-context-BoAPwiiZ.js","assets/AdminEditor-Cn4ncppF.js","assets/page-CA8AqiPK.js"];
...
function getDraftSecret() {
	return "b473a02c-8d5c-42c7-921f-ae48950502f3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "8d8ee101-2679-4ea3-943c-6a1ac6146586";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "8d8ee101-2679-4ea3-943c-6a1ac6146586") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "8d8ee101-2679-4ea3-943c-6a1ac6146586",
		rootBoundaryId
	});
}
/**
