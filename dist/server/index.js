globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/layout-segment-context-DArBg8dY.js","assets/AdminEditor-UEcGRhkq.js","assets/page-DV51QjBD.js"];
...
function getDraftSecret() {
	return "82b94058-c44d-4ef8-9525-2f84e56c8124";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "8b8dd7e1-57c8-4b91-8030-c785215620b0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "8b8dd7e1-57c8-4b91-8030-c785215620b0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "8b8dd7e1-57c8-4b91-8030-c785215620b0",
		rootBoundaryId
	});
}
/**
