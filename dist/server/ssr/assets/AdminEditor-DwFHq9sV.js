...
function AdminEditor() {
	...
	const [visits, setVisits] = (0, import_react.useState)(emptyVisits);
	...
	const loadVisits = () => fetch("/api/analytics/visit").then((response) => response.ok ? response.json() : Promise.reject()).then((data) => setVisits({
		total: Number(data.total || 0),
		today: Number(data.today || 0),
		breakdown: {
			...emptyVisits.breakdown,
			...data.breakdown || {}
		}
	})).catch(() => {});
	(0, import_react.useEffect)(() => {
				...
				tab === "home" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Quick, {
							title: tr(`إجمالي الزيارات • اليوم ${visits.today}`, `Total visits • Today ${visits.today}`),
							value: visits.total.toLocaleString(lang === "ar" ? "ar-SA" : "en-US"),
							action: tr("تحديث", "Refresh"),
							onClick: loadVisits
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Quick, {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: tr("تفاصيل الزوار", "Visitor insights") }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: tr("بيانات مجمعة بدون تخزين عنوان IP أو معلومات تعريف شخصية.", "Aggregated statistics without storing IP addresses or personal identifiers.") })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: loadVisits,
								children: tr("تحديث البيانات", "Refresh data")
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsCard, {
									title: tr("الأجهزة", "Devices"),
									items: visits.breakdown.device,
									lang
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsCard, {
									title: tr("أنظمة التشغيل", "Operating systems"),
									items: visits.breakdown.os,
									lang
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsCard, {
									title: tr("المتصفحات", "Browsers"),
									items: visits.breakdown.browser,
									lang
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsCard, {
									title: tr("الدول", "Countries"),
									items: visits.breakdown.country,
									lang,
									countries: true
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsCard, {
									title: tr("مصادر الزيارة", "Traffic sources"),
									items: visits.breakdown.source,
									lang
								})
							] })]
						})
...
function AnalyticsCard({ title, items, lang, countries = false }) {
	const label = (value) => {
		if (!countries || value === "Unknown") return value;
		try {
			return new Intl.DisplayNames([lang === "ar" ? "ar" : "en"], { type: "region" }).of(value) || value;
		} catch {
			return value;
		}
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: title }), items.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: label(item.value) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: item.visits.toLocaleString(lang === "ar" ? "ar-SA" : "en-US") })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { style: { width: `${Math.max(5, item.visits / max * 100)}%` } }) })] }, item.value)) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: lang === "ar" ? "لا توجد بيانات بعد" : "No data yet" })]
	});
}
